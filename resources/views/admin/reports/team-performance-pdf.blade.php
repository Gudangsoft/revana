...
<head>
    ...
    <title>Laporan Tim {{ $config['title'] ?? 'Performance' }} Terbanyak</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .header {
            ...
            margin-bottom: 20px;
            padding-bottom: 15px;
            border-bottom: 3px solid {{ $config['color'] ?? '#0d6efd' }};
        }
        .header h1 {
            font-size: 16pt;
        ...
        .stats-box {
            ...
            background: linear-gradient(to bottom, {{ $config['color'] ?? '#0d6efd' }}, #333);
            color: white;
        }
        .stats-box h3 {
            font-size: 18pt;
        ...
        table.ranking th {
            background: {{ $config['color'] ?? '#0d6efd' }};
            color: white;
            padding: 8px 10px;
            text-align: left;
            font-size: 9pt;
...
<body>
    <div class="header">
        <h1>Laporan Tim {{ $config['title'] ?? 'Performance' }} Terbanyak</h1>
