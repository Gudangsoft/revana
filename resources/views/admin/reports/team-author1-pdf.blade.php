...
<head>
    <meta charset="utf-8">
    <title>Laporan Tim Author 1 Terbanyak</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>LAPORAN TIM AUTHOR 1 TERBANYAK</h1>
    ...
    <table class="ranking">
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="4" style="text-align: center; padding: 20px;">Belum ada data tugas Author 1</td>
            </tr>
            @endforelse
        </tbody>
    </table>
