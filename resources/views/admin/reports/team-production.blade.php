...
@section('title', 'Laporan Tim Production Terbanyak')
@section('page-title', 'Laporan Tim Production Terbanyak')
        ...
        <div class="card bg-secondary text-white h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-0">Total Tugas Production</h6>
    ...
    <div class="col-md-4 mb-3">
        <div class="card bg-success text-white h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-0">Total PIC Production</h6>
    ...
    <div class="col-md-4 mb-3">
        <div class="card bg-warning text-dark h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-0">Top Production</h6>
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-4 d-flex align-items-end gap-2">
                ...
                <a href="{{ route('admin.team-production-report') }}" class="btn btn-outline-secondary">
                    <i class="bi bi-arrow-clockwise"></i> Reset
                </a>
                <a href="{{ route('admin.team-production-report', array_merge(request()->query(), ['export' => 'pdf'])) }}" class="btn btn-danger">
...
<div class="card">
    <div class="card-header bg-secondary text-white">
        <i class="bi bi-trophy-fill"></i> Peringkat Tim Production Terbanyak
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" class="text-center text-muted py-4">
                            ...
                            <p class="mb-0">Belum ada data tugas Production</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="card-footer text-muted">
        Total {{ $picProductions->count() }} PIC yang melakukan tugas Production
    </div>
</div>
