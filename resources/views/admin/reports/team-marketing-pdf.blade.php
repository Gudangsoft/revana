...
<body>
    ...
    <div class="stats-box">
        <table>
            <tr>
                ...
                <td width="33%">
                    <small>Total Marketing</small><br>
                    <span class="stat-value">{{ number_format($stats['total_marketing']) }}</span>
                </td>
                <td width="33%">
                    <small>Top Marketing</small><br>
                    <span class="stat-value">{{ $stats['top_marketing'] ? $stats['top_marketing']->marketing_name : '-' }}</span>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table class="ranking">
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="4" style="text-align: center; padding: 20px;">Belum ada data marketing</td>
            </tr>
            @endforelse
        </tbody>
    </table>
