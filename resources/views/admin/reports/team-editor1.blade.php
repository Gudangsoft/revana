...
@section('title', 'Laporan Tim Editor 1 Terbanyak')
@section('page-title', 'Laporan Tim Editor 1 Terbanyak')
        ...
        <div class="card bg-primary text-white h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-0">Total Tugas Editor 1</h6>
    ...
    <div class="col-md-4 mb-3">
        <div class="card bg-success text-white h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-0">Total PIC Editor 1</h6>
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-4 d-flex align-items-end gap-2">
                ...
                <a href="{{ route('admin.team-editor1-report') }}" class="btn btn-outline-secondary">
                    <i class="bi bi-arrow-clockwise"></i> Reset
                </a>
                <a href="{{ route('admin.team-editor1-report', array_merge(request()->query(), ['export' => 'pdf'])) }}" class="btn btn-danger">
...
<div class="card">
    <div class="card-header bg-primary text-white">
        <i class="bi bi-trophy-fill"></i> Peringkat Tim Editor 1 Terbanyak
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" class="text-center text-muted py-4">
                            ...
                            <p class="mb-0">Belum ada data tugas Editor 1</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="card-footer text-muted">
        Total {{ $picEditor1s->count() }} PIC yang melakukan tugas Editor 1
    </div>
</div>
