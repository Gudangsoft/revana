...
<div id="modal-send-loa" class="no-print"
    ...
    <div style="background:#1e1e2e; color:#e0e0e0; border-radius:10px; width:100%; max-width:500px;
        ...
        @php
            ...
            $waClickRoute = (!empty($isMarketingView) && $isMarketingView)
                ? route('marketing.loa-master.wa-click', $submission)
                : route('admin.loa-master.wa-click', $submission);
        @endphp
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap;">
            ...
            <div style="flex:1; min-width:140px;">
                ...
                <div style="text-align:center; font-size:11px; color:#888; margin-top:4px;">
                    Diklik {{ $submission->loa_wa_sent_count ?? 0 }}x
                </div>
            </div>
            @else
