            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('program_type') is-invalid @enderror" id="program_type" name="program_type">
                        ...
                        <option value="bkd" {{ old('program_type') == 'bkd' ? 'selected' : '' }}>BKD (Beban Kerja Dosen)</option>
                        <option value="jafa" {{ old('program_type') == 'jafa' ? 'selected' : '' }}>JAFA (Jabatan Fungsional Akademik)</option>
                    </select>
                    @error('program_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
