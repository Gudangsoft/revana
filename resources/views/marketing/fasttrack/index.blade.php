...
<div class="card border-warning">
    <div class="card-header bg-warning text-dark py-2">
        <i class="bi bi-table"></i> Tabel Monitoring Fasttrack
    </div>
    <div class="card-body p-0">
        <!-- Scroll Controls -->
        <div class="scroll-controls m-2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="sticky-first">
                            <a href="{{ route('marketing.fasttrack.show', $s) }}" class="text-decoration-none">
                        ...
                        <td class="text-center">
                            <a href="{{ route('marketing.fasttrack.show', $s) }}" class="btn btn-info btn-sm">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
