      ...
      <tr>
        <td style="padding:28px 28px 20px;">
          ...
          <p style="font-size:14px;line-height:1.7;margin:0 0 16px;">
            Berikut kami sampaikan kwitansi pembayaran untuk:
          </p>
          ...
          <table width="100%" cellpadding="6" cellspacing="0" style="font-size:14px;margin-bottom:20px;">
            <tr><td style="color:#666;width:140px;">No. Kwitansi</td><td>{{ $nomorKwitansi }}</td></tr>
            <tr><td style="color:#666;">Jumlah</td><td><strong>Rp {{ number_format($jumlah, 0, ',', '.') }}</strong></td></tr>
            <tr><td style="color:#666;">Metode Bayar</td><td>{{ $metodeBayar }}</td></tr>
            <tr><td style="color:#666;">Tanggal</td><td>{{ $tanggal->translatedFormat('d F Y') }}</td></tr>
          </table>

          <p style="font-size:14px;line-height:1.7;margin:0 0 8px;">
            File PDF kwitansi terlampir pada email ini. Terima kasih atas pembayaran Anda.
          </p>
        </td>
      </tr>
