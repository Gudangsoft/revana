            ...
            <div class="card-body">
                ...
                <form action="{{ route('pic.submissions.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="jenis_jurnal_id" class="form-label">Jenis Jurnal <span class="text-danger">*</span></label>
                                <select class="form-select @error('jenis_jurnal_id') is-invalid @enderror" id="jenis_jurnal_id" name="jenis_jurnal_id" required>
