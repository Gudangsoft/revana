...
@section('page-title', 'Dashboard PIC')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">Anda login sebagai <strong>PIC {{ ucfirst(strtolower(auth()->guard('pic')->user()->role ?? 'Author')) }}</strong>. Gunakan dashboard ini untuk mengelola tugas dan monitoring artikel.</p>
            </div>
        </div>
    </div>
</div>
                        ...
                        <a href="{{ route('pic.submissions.monitoring') }}" class="text-decoration-none">
                            <div class="card h-100 border-primary">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-title mt-2 mb-1">Monitoring & Tugas</h6>
                                    <p class="card-text text-muted small">Lihat dan kelola tugas yang ditugaskan</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="{{ route('pic.journals.index') }}" class="text-decoration-none">
                            <div class="card h-100 border-success">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-title mt-2 mb-1">Data Jurnal</h6>
                                    <p class="card-text text-muted small">Kelola data jurnal</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="{{ route('pic.submissions.index') }}" class="text-decoration-none">
                            <div class="card h-100 border-info">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-title mt-2 mb-1">Kelola Jurnal</h6>
                                    <p class="card-text text-muted small">Kelola submission jurnal normal</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="{{ route('pic.fasttrack.index') }}" class="text-decoration-none">
                            <div class="card h-100 border-warning">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-title mt-2 mb-1">Kelola Jurnal FS</h6>
                                    <p class="card-text text-muted small">Kelola submission jurnal fasttrack</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-md-3">
                        <a href="{{ route('pic.journal-slots.index') }}" class="text-decoration-none">
                            <div class="card h-100 border-danger">
                                <div class="card-body text-center">
                                    <i class="bi bi-rocket text-danger" style="font-size: 2.5rem;"></i>
                                    <h6 class="card-title mt-2 mb-1">Data Jurnal FS</h6>
                                    <p class="card-text text-muted small">Kelola data jurnal fasttrack</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="{{ route('pic.points.index') }}" class="text-decoration-none">
                            <div class="card h-100 border-warning">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-title mt-2 mb-1">Point Saya</h6>
                                    <p class="card-text text-muted small">Lihat perolehan point</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="{{ route('pic.points.rankings') }}" class="text-decoration-none">
                            <div class="card h-100 border-success">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-title mt-2 mb-1">Peringkat Point</h6>
                                    <p class="card-text text-muted small">Lihat peringkat point PIC & Marketing</p>
                                </div>
                            </div>
                        </a>
                    </div>
