                    ...
                    <table class="table table-monitoring table-bordered">
                        <thead>
                            ...
                            <tr>
                                ...
                                <!-- Editor 2 (4 cols) -->
                                <th style="background:#38bdf8;color:#0c4a6e;font-weight:700;font-size:0.72rem;border-left:3px solid #0284c7;">Petugas</th>
                                <th style="background:#38bdf8;color:#0c4a6e;font-weight:700;font-size:0.72rem;">User/Pass R1</th>
                                <th style="background:#38bdf8;color:#0c4a6e;font-weight:700;font-size:0.72rem;">User/Pass R2</th>
                                <th style="background:#38bdf8;color:#0c4a6e;font-weight:700;font-size:0.72rem;">Valid</th>
                                <!-- Reviewer 1 (4 cols) -->
                        ...
                        <tbody>
                            ...
                            @php
                                ...
                                $isMyTask = $s->petugas_editor1_id==$picId||$s->petugas_author1_id==$picId||$s->petugas_editor2_id==$picId||$s->petugas_reviewer1_id==$picId||$s->petugas_reviewer2_id==$picId||$s->petugas_editor3_id==$picId||$s->petugas_author2_id==$picId||$s->petugas_production_id==$picId;
                            @endphp
                            <tr class="{{ $rowClass }} {{ $isMyTask ? 'my-task' : '' }}"
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="progress-counter mt-1"><span class="done">{{ $validCount }}</span>/8 ✓</div>
                                </td>
    ...
    document.querySelectorAll('.validation-toggle').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            for (let i = 0; i < currentStageIndex; i++) {
                ...
                // SPECIAL CASE 3: Validator - Editor 3 dan Author 2 tidak wajib selesai
