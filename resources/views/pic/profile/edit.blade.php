...
<div class="row">
    <div class="col-md-8 mx-auto">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('pic.profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="mb-3">
                                ...
                                @else
                                    <div class="rounded-circle bg-secondary d-inline-flex align-items-center justify-content-center" 
                                         style="width: 150px; height: 150px; border: 4px solid #0d6efd;">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="username" 
                                       name="username" 
                                       value="{{ old('username', $pic->username) }}" 
                                       required>
                                @error('username')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('pic.dashboard') }}" class="btn btn-secondary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('pic.profile.update-password') }}" method="POST">
                    @csrf
