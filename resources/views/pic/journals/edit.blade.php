...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('pic.journals.update', $journal) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_jurnal') is-invalid @enderror" 
                               name="nama_jurnal" value="{{ old('nama_jurnal', $journal->nama_jurnal) }}" required>
                        @error('nama_jurnal')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('link_jurnal') is-invalid @enderror" 
                               name="link_jurnal" value="{{ old('link_jurnal', $journal->link_jurnal) }}" placeholder="https://...">
                        @error('link_jurnal')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" 
                                   id="is_active" {{ old('is_active', $journal->is_active) ? 'checked' : '' }}>
