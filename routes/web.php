...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware(\App\Http\Middleware\AdminMiddleware::class)->group(function () {
        ...
        Route::prefix('fasttrack-management')->name('fasttrack-management.')->middleware('feature:fasttrack')->group(function () {
        ...
        // Certificates
        Route::resource('certificates', \App\Http\Controllers\Admin\CertificateController::class)->middleware('feature:certificates');        Route::get('/reviewers/{reviewer}/edit', [ReviewerController::class, 'edit'])->name('reviewers.edit');
        ...
        // Leaderboard
        Route::get('/leaderboard', [LeaderboardController::class, 'index'])->name('leaderboard.index')->middleware('feature:leaderboard');
        ...
        Route::post('/marketings/return-to-admin', [MarketingController::class, 'returnToAdmin'])->name('marketings.return-to-admin');
        ...
        Route::get('/laporan-harian/export', [\App\Http\Controllers\Admin\LaporanHarianController::class, 'export'])->name('laporan-harian.export');
        Route::get('/laporan-harian/rekap', [\App\Http\Controllers\Admin\LaporanHarianController::class, 'rekap'])->name('laporan-harian.rekap');
        Route::get('/laporan-harian/rekap/export', [\App\Http\Controllers\Admin\LaporanHarianController::class, 'exportRekap'])->name('laporan-harian.rekap.export');
...
Route::prefix('marketing')->group(function () {
    ...
    Route::middleware('auth:marketing')->group(function () {
        ...
        Route::post('/loa-master/{submission}/resend-wa', [MarketingDashboardController::class, 'loaMasterResendWa'])->name('marketing.loa-master.resend-wa');
