...
<?php $__env->startSection('title', 'Tambah Marketing - REVANA'); ?>
<?php $__env->startSection('page-title', 'Tambah Marketing'); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <i class="bi bi-plus-circle"></i> Form Tambah Marketing
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('admin.marketings.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LPKD-APJI\REVANA\resources\views/admin/marketings/create.blade.php ENDPATH**/ ?>